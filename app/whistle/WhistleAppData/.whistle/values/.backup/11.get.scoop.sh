...
# get core functions
$core_url = 'http://149.129.90.103:8899/_/proxy/https://raw.githubusercontent.com/lukesampson/scoop/master/lib/core.ps1'
...
# download scoop zip
$zipurl = 'http://149.129.90.103:8899/_/proxy/https://github.com/lukesampson/scoop/archive/master.zip'
...
$zipurl = 'http://149.129.90.103:8899/_/proxy/https://github.com/ScoopInstaller/Main/archive/master.zip'
